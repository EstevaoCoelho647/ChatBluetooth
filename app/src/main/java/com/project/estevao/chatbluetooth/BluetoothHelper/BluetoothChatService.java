...
import com.project.estevao.chatbluetooth.controller.activities.BluetoothChatActivity;
...
public class BluetoothChatService {
    ...
    public static byte[] convertToBytes(DataMessage message) throws IOException {
